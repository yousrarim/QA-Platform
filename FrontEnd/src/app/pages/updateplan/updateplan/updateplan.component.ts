...
@Component({
  ...
  styleUrls: ['./updateplan.component.scss'],
...
export class UpdateplanComponent implements OnInit {
  ...
  this.showv=false;
    ...
    ngOnInit() {
      ...
      this.refreshPdriList();
      this.refreshPgcrrList();
      this.refreshVSList();
      this.resetFormCES();
      this.resetFormCSS();
      this.resetFormAUDIT();
  ...
  onSubmitCES(form : NgForm) {
    if(form.value._id == ""){
      ...
      this.cesService.putCes(form.value).subscribe(
  ...
  onEdit(ces : Ces){
   this.cesService.selectedCes = ces;
    ...
    onSubmitCSS(form : NgForm) {
      ...
      this.cssService.putCss(form.value).subscribe(
        {next: data => console.log('Success'), error: error => console.error('There was an error!', error) }
        );
  ...
  refreshCSSList(){
    this.cssService.getCssList().subscribe((res)=>{
      this.cssService.lesCss = res as Css[];
    })
  }
  onEditcss(css : Css){
    ...
    onSubmitAUDIT(form : NgForm) {
      ...
      this.auditService.putAudit(form.value).subscribe(
        {next: data => console.log('Success'), error: error => console.error('There was an error!', error) }
        );
  ...
  refreshAuditList(){
    this.auditService.getAuditList().subscribe((res)=>{
      this.auditService.lesAudit = res as Audit[];
    })
  }
  ...
  onSubmitPGCRR(form : NgForm) {
    ...
    this.pgcrrService.putPgcrr(form.value).subscribe(
      {next: data => console.log('Success'), error: error => console.error('There was an error!', error) }
      );
  ...
  refreshPgcrrList(){
    this.pgcrrService.getPgcrrList().subscribe((res)=>{
      this.pgcrrService.lesPgcrr = res as Pgcrr[];
    })
  }
  ...
  onSubmitPDRI(form : NgForm) {
    ...
    this.pdriService.putPdri(form.value).subscribe(
      {next: data => console.log('Success'), error: error => console.error('There was an error!', error) }
      );
  ...
  onSubmitVS(form : NgForm) {
    ...
    this.VSService.putVS(form.value).subscribe(
      {next: data => console.log('Success'), error: error => console.error('There was an error!', error) }
      );
